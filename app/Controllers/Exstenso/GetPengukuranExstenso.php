...
class GetPengukuranExstenso extends Controller
{
    protected $db;

    public function __construct()
    {
        $this->db = Database::connect('db_exs'); // Gunakan koneksi db_exs
    ...
    public function index()
    {
        try {
            ...
            $query = $this->db->table("t_pengukuran_eks")
            ...
            log_message('error', '[GetPengukuranExstenso] Error: ' . $e->getMessage());
            return $this->response->setJSON([
                "status" => "error",
