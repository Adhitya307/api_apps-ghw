...
class MPergerakanElv625 extends Model
{
    ...
    public function hitungPergerakan($id_pengukuran)
    {
        ...
        $pembacaanModel = new \App\Models\DomBody\MPembacaanElv625();
        $initialModel = new \App\Models\DomBody\InitialReadingElv625Model();
        ...
        // Hitung selisih pergerakan (pembacaan - initial)
        $hasil = [
    ...
    /**
     * 🔹 Hitung semua pergerakan untuk semua pengukuran
     */
    ...
    /**
     * Ambil data pergerakan berdasarkan id_pengukuran
     */
    ...
    /**
     * Update data pergerakan berdasarkan id_pengukuran
     */
